    ...
    //while (counter < number_of_operations) {
        ...
        if (done) {
            ...
            switch (operation_list[counter])
            {
                ...
                case 3:
                {
                    std::cout << "Method: " << operation_list[counter] << " Value: " << temp_amount.range(31, 0) << std::endl;
                    if (!permissibility_req.full()) {
                        temp_amount = amount_list[counter];
                        proposed_value.range(31, 30) = operation_list[counter]; 
        ...
        if (!smr_updated.empty()) {
            ...
            {
            case 0:
                std::cout << "AddMovie - Movie ID: " << local_update.range(29, 0) << std::endl; 
                movies[local_update.range(29, 0)] = true;
                movie_size++;
                break;
            
            case 1:
                std::cout << "DeleteMovie - Movie ID: " << local_update.range(29, 0) << std::endl; 
                movies[local_update.range(29, 0)] = false; 
                movie_size--;
                break; 

            case 2:
                std::cout << "AddCustomer Customer ID: " << local_update.range(29, 0)  << std::endl; 
                customers[local_update.range(29, 0)] = true;
                customer_size++;
                break;

            case 3:
                std::cout << "RemoveCustomer Customer ID: " << local_update.range(29, 0)  << std::endl; 
                customers[local_update.range(29, 0)] = false;
                customer_size--;
                break;
            default:
                break;
        ...
        if (!update_rsp.empty()) {
            ...
            std::cout << "Updaing from Log! Method: " << remote_update.range(31, 30) << " Operation: " << remote_update.range(29, 0) << std::endl; 
            switch (remote_update.range(31, 30))
            {
            case 0:
                std::cout << "AddMovie - Movie ID: " << remote_update.range(29, 0) << std::endl; 
                movies[remote_update.range(29, 0)] = true;
                movie_size++;
                break;
            
            case 1:
                std::cout << "DeleteMovie - Movie ID: " << remote_update.range(29, 0) << std::endl; 
                movies[remote_update.range(29, 0)] = false; 
                movie_size--;
                break; 

            case 2:
                std::cout << "AddCustomer Customer ID: " << remote_update.range(29, 0)  << std::endl; 
                customers[remote_update.range(29, 0)] = true;
                customer_size++;
                break;

            case 3:
                std::cout << "RemoveCustomer Customer ID: " << remote_update.range(29, 0)  << std::endl; 
                customers[remote_update.range(29, 0)] = false;
                customer_size--;
                break;
            default:
                break;
